<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SecaoPaxDadosAeropDecol.ascx.cs" Inherits="SIGLA.Web.Controles.SecaoPaxDadosAeropDecol" %>
	...
	<table>
		<tr>
			<td>
				...
				<asp:Label ID="lblPaxDhc" runat="server" Text="DHC:" CssClass="lblConexaoStyle1 tamanhoFonteStyle1"></asp:Label>
				<asp:TextBox ID="txtPaxDhc" runat="server" CssClass="txtConexaoStyle1 tamanhoFonteStyle1" 
					MaxLength="3"></asp:TextBox>
				<cc1:MaskedEditExtender ID="txtPaxDhc_MaskedEditExtender" runat="server" 
					AutoComplete="False" CultureAMPMPlaceholder="" 
					CultureCurrencySymbolPlaceholder="" CultureDateFormat="" 
					CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
					CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
					InputDirection="RightToLeft" Mask="999" MaskType="Number" 
					TargetControlID="txtPaxDhc">
				</cc1:MaskedEditExtender>
			</td>
		</tr>
	</table>

...
<%
  ...
  strSqlSelect = strSqlSelect & "                  AND sdt1.seqtrecho = sig_diariotrecho.seqtrecho "
  ...
  strSqlSelect = strSqlSelect & "                  AND sdt3.seqtrecho = sig_diariotrecho.seqtrecho "
  ...
  strSqlSelect = strSqlSelect & "                  AND sdt2.seqtrecho = sig_diariotrecho.seqtrecho "
  ...
  strSqlSelect = strSqlSelect & "                  AND sdt4.seqtrecho = sig_diariotrecho.seqtrecho "
  ...
  strSqlFrom = " FROM "
  strSqlFrom = strSqlFrom & " sig_diariovoo, sig_diariotrecho "

  strSqlWhere = " WHERE "
  strSqlWhere = strSqlWhere & "       sig_diariovoo.seqvoodia = sig_diariotrecho.seqvoodia "
  strSqlWhere = strSqlWhere & "   AND sig_diariovoo.tipovoo = '0' "

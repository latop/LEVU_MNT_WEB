...
<body onload="enviar();">
	<form name='sigla'  id = 'sigla' action='http://biblioteca.webjet.ws/biblioteca/bl_latop/latop_bl_consulta_trip_inter.php' method='post'>
		<div>
			<!-- <li style='font-size: 17 px'> -->
			<!-- <a href='javascript: document.sigla.submit ();' class='CORPO' style='font-size: 17 px'>Biblioteca Eletrônica - Consulta Publicações</a></li> -->

...
<%
	...
	If (Not IsVazio(strVoltar)) Then
		Response.Redirect("relatorioescalaapresentacaoc.asp")
	ElseIf (Not IsVazio(strConfirmar)) Then
		...
		Else
			...
			Else
				...
				Call RedirectJS("relatorioescalaapresentacaoc.asp")
...
%>
	...
	<form action="relatorioescalaapresentacaoregistroc.asp" method="post" id="form1" name="form1">

...
<body onload="enviar();">
	<form name='sigla'  id = 'sigla' action='http://biblioteca.webjet.ws/contatos/latop_ctd_form.php' method='post'>
		<div>
			<!-- <li style='font-size: 17 px'> -->
			<!-- <a href='javascript: document.sigla.submit ();' class='CORPO' style='font-size: 17 px'>Contato com Operações</a></li> -->

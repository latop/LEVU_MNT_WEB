-<%@ Language=VBScript %>
 ...
 -	strSqlUsuario = strSqlUsuario & " WHERE SIA.codiata = '" & ObterCodIata() & "' "
 -
 -	Dim objRsUsuario
 ...
 -		Response.Write("		<a href='relatorioescalaapresentacaoregistro" & ObterComplementoNomeArquivo() & ".asp?seqjornada=" & objRs("SeqJornada") & "'>" & objRs("NomeGuerra") & " &nbsp;</td>" & vbCrLf)
 ...
 -	' ***   "relatorioescalaapresentacao"            ***
 -	' **************************************************
 -	Function ObterCodIata()
 -
 -		Dim strNomeArquivo
 -		strNomeArquivo = ObterNomeArquivo()
 -		strNomeArquivo = Replace(strNomeArquivo, "relatorioescalaapresentacao", "")
 -
 -		Dim strCodIata

...
<body onload="enviar();">
	<form name='sigla'  id = 'sigla' action='http://200.152.104.75/auttripextra/auttrext_cancelam.php' method='post'>
		<div>
			<!-- <li style='font-size: 17 px'> -->
			<!-- <a href='javascript: document.sigla.submit ();' class='CORPO' style='font-size: 17 px'>Passe Tripulante Extra</a></li> -->

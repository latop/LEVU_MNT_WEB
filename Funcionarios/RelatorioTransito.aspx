<%@ Page Title="Movimento de Trânsito" Language="C#" MasterPageFile="~/Funcionarios/Funcionarios.Master" AutoEventWireup="true" CodeBehind="RelatorioTransito.aspx.cs" Inherits="SIGLA.Web.Funcionarios.RelatorioTransito" %>
	...
	<asp:MultiView ID="mvwMovimentoTransito" runat="server">
		<asp:View ID="vwRelatorioSemSetores" runat="server">
			...
			<table width="98%" border="1" cellpadding="0" cellspacing="0" style="text-align:left; font-family:Verdana,Arial,Sans-Serif;">
                ...
                <tr>
					<td style="padding-left:5px; font-size:9pt; width:50%;">HANDLING:&nbsp;</td>
					<td style="padding-left:5px; font-size:9pt; width:50%;">DESPACHO:&nbsp;</td>
				</tr>
			</table>
			</center>
			</div>
